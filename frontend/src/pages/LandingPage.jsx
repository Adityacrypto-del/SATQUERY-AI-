...
const CAPABILITIES = [
  {
    icon: Eye,
    title: 'Single Image Specialist',
    body: 'Extracts spatial features, localized bounding regions, and land use compositions from high-res multispectral Sentinel-2/GeoTIFF scenes.',
    tag: 'Branch 1 • Features & VQA'
  },
  {
    icon: Clock,
    title: 'Bi-Temporal Change Specialist',
    body: 'Co-registers Pre-event (T1) and Post-event (T2) passes, computing difference heatmaps and quantifying flood or deforestation delta.',
    tag: 'Branch 2 • Change Tokens'
  },
  {
    icon: Radio,
    title: 'Optical + SAR Cross-Modal Fusion',
    body: 'Fuses 13-band Sentinel-2 Optical with Sentinel-1 SAR Radar (VV/VH). C-band radar penetrates cloud occlusion for all-weather vision.',
    tag: 'Branch 3 • Radar Fusion'
  },
];
